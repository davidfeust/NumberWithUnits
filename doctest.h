...
// ======================================================================
//
// doctest.h - the lightest feature-rich C++ single-header testing framework for _unit tests and TDD
//
...
// this is here to clear the 'current test suite' for the current translation _unit - at the top
...
// required includes - will go only in one translation _unit!
#include <ctime>
#include <cmath>
#include <climits>
    ...
    void XmlEncode::encodeTo( std::ostream& os ) const {
        ...
        for( std::size_t idx = 0; idx < m_str.size(); ++ idx ) {
            ...
            default:
                ...
                for (std::size_t _n = 1; _n < encBytes; ++_n) {
                    uchar nc = m_str[idx + _n];
                    valid &= ((nc & 0xC0) == 0x80);
                ...
                for (std::size_t _n = 0; _n < encBytes; ++_n) {
                    os << m_str[idx + _n];
                }
                idx += encBytes - 1;
                break;
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printHelp() {
            ...
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "gfl, --" DOCTEST_OPTIONS_PREFIX_DISPLAY "gnu-file-line=<bool>          "
              << Whitespace(sizePrefixDisplay*1) << ":_n: vs (_n): for line numbers in output\n";
