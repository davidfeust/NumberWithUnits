...
//
    ...
    NumberWithUnits x{500, "cm"};  // 300 meters
    cout << (a + b) << endl;   // Prints "2.3[km]". Note: units are determined by first number (a).
    cout << (b + a) << endl;   // Prints "2300[m]". Note: units are determined by first number (b).
    cout << (x + b) << endl;   // Prints "30500[cm]". Note: units are determined by first number (b).
    cout << (a + x) << endl;   // Prints "30500[km]". Note: units are determined by first number (b).
